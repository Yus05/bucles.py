...
#-> El primer argumento representa el inicio. Entonces si yo uso el i, como primer argumento, quiere decir que comienza ahi, que comience a partir de ese valor en cada iteracion. O sea que comience, a partir de lo que suelta el for anterior.
#-> El segundo argumento en realidad es el limite. El limite en este caso es hasta donde "debe llegar la iteracion", en el primer for ese limite es el numero que pone el usuario, en este ejemplo es 0, pero no 0 sino el numero aterior a 0.
